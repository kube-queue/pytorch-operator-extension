...
import (
	jobcontrollerv1 "github.com/kube-queue/pytorch-operator-extension/pkg/pytorch-operator/apis/common/job_controller/v1"
...
func (in *PyTorchJobSpec) DeepCopyInto(out *PyTorchJobSpec) {
	*out = *in
	...
	if in.CleanPodPolicy != nil {
		...
		*out = new(jobcontrollerv1.CleanPodPolicy)
		**out = **in
	}
	...
	if in.PyTorchReplicaSpecs != nil {
		...
		*out = make(map[PyTorchReplicaType]*jobcontrollerv1.ReplicaSpec, len(*in))
		for key, val := range *in {
			var outVal *jobcontrollerv1.ReplicaSpec
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(jobcontrollerv1.ReplicaSpec)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
